...
const ProductDetail = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <div className="max-w-6xl my-0 mx-[69px] px-0 py-[146px]">
          <Link to="/produtos" className="inline-flex items-center text-gray-600 hover:text-black transition-colors mb-8 -ml-1">
