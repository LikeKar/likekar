...
const ProductDetail = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        <Link to="/produtos" className="inline-flex items-center text-gray-600 hover:text-black transition-colors mb-8">
          <ArrowLeft className="mr-2 h-4 w-4" />
          Voltar para Produtos
        </Link>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 px-[240px] py-0 my-0">
