    ...
    <div className="min-h-screen pt-20 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div className="text-center">
          ...
          <h1 className="mt-6 text-4xl sm:text-6xl font-extrabold font-montserrat text-likekar-black tracking-tight animate-fadeIn" style={{ animationDelay: '0.2s' }}>
            Tudo para seu carro em
            <span className="block text-likekar-yellow">um só lugar</span>
          </h1>
          
          <p className="mt-6 max-w-lg mx-auto text-lg text-gray-600 font-inter animate-fadeIn" style={{ animationDelay: '0.4s' }}>
            Som automotivo, películas, acessórios e muito mais.
            Trabalhamos com as melhores marcas do mercado.
          </p>
          
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center items-center animate-fadeIn" style={{ animationDelay: '0.6s' }}>
          ...
          <div className="mt-20 grid grid-cols-2 sm:grid-cols-4 gap-8 animate-fadeIn" style={{ animationDelay: '0.8s' }}>
            <div className="flex flex-col items-center">
              <div className="font-montserrat font-bold text-2xl text-likekar-black">10+</div>
              <div className="text-gray-600 font-inter text-sm">Anos de Experiência</div>
            </div>
            <div className="flex flex-col items-center">
              <div className="font-montserrat font-bold text-2xl text-likekar-black">500+</div>
            ...
            <div className="flex flex-col items-center">
              <div className="font-montserrat font-bold text-2xl text-likekar-black">1000+</div>
